...
//!
//! 1. Everything is downloaded to `_valsync_tmp/` inside the game folder and
...
use valsync_core::plan::{PlanCounts, PlannedFile};
use valsync_core::{
...
pub fn prepare(
    ...
    let (manifest, _) = ctx
        ...
        .map_err(|e| match e {
            ...
            SyncError::Core(valsync_core::CoreError::BadSignature) => SyncError::KeyMismatch {
