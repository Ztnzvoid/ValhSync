...
use valhsync_core::steam::{self, VALHEIM_APP_ID};
...
/// game's own environment (Proton, overlay); ValhSync never runs the game
/// binary itself.
...
/// ValhSync does not edit Steam launch options (out of scope for v1).
