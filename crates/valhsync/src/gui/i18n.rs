...
fn strings(key: Key) -> [&'static str; LANGS] {
    match key {
        ...
        Key::BuiltWithAi => [
            ...
            "Erstellt mit Hilfe eines KI-Assistenten (Claude), von einem Menschen angeleitet und geprüft.",
            "Creado con la ayuda de un asistente de IA (Claude), dirigido y revisado por una persona.",
            "Realizzato con l'aiuto di un assistente IA (Claude), guidato e revisionato da una persona.",
            "Powstało z pomocą asystenta AI (Claude), prowadzonego i sprawdzanego przez człowieka.",
            "Feito com a ajuda de um assistente de IA (Claude), orientado e revisado por uma pessoa.",
            "Создано с помощью ИИ-ассистента (Claude) под руководством и с проверкой человеком.",
        ],
        Key::Subtitle => [
        ...
        Key::InvitePrompt => [
            "The game server's address — the same one you type in Valheim. An invite code works too.",
            "L'adresse du serveur de jeu — la même que dans Valheim. Un code d'invitation marche aussi.",
            "Die Adresse des Spielservers — dieselbe wie in Valheim. Ein Einladungscode geht auch.",
            "La dirección del servidor — la misma que escribes en Valheim. También sirve un código de invitación.",
            "L'indirizzo del server — lo stesso che usi in Valheim. Va bene anche un codice d'invito.",
            "Adres serwera — ten sam co w Valheim. Kod zaproszenia też zadziała.",
            "O endereço do servidor — o mesmo que você usa no Valheim. Um código de convite também funciona.",
            "Адрес игрового сервера — тот же, что и в Valheim. Код приглашения тоже подойдёт.",
        ],
        Key::InviteHint => [
            "203.0.113.10:2456   or   valhsync1:…",
            "203.0.113.10:2456   ou   valhsync1:…",
            "203.0.113.10:2456   oder   valhsync1:…",
            "203.0.113.10:2456   o   valhsync1:…",
            "203.0.113.10:2456   o   valhsync1:…",
            "203.0.113.10:2456   lub   valhsync1:…",
            "203.0.113.10:2456   ou   valhsync1:…",
            "203.0.113.10:2456   или   valhsync1:…",
        ],
        Key::Crashed => [
